...
class testDropdownMenuDisplay {
    ...
    fun testDropdownMenuDisplay() {
        ...
        listOf("Главная", "Новости", "О приложении").forEach { title ->
            checkMenuItemDisplayed(title)
        }
    }
    ...
    private fun checkMenuItemDisplayed(title: String) {
        onView(
            allOf(
